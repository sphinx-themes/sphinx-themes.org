==========================
{{ theme.display }} Sample
==========================

This is a demo site for {{ theme.display }}, generated as part of
...
You can find this theme's documentation at {{ theme.documentation_link }}.
{%- else -%}
...
.. Make sure that the navigation structure below matches the one in
   `sample-docs/conf.py`.
